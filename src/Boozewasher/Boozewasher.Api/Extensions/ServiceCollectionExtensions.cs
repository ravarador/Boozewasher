using Boozewasher.Api.Services;
using Boozewasher.Application.DTOs.Settings;
using Boozewasher.Application.Interfaces;
...
using Boozewasher.Infrastructure.Identity.Services;
using Boozewasher.Infrastructure.Shared.Services;
...
namespace Boozewasher.Api.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\Boozewasher.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
