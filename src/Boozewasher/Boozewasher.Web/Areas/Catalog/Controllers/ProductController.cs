using Boozewasher.Application.Constants;
...
using Boozewasher.Application.Features.Products.Commands.Delete;
...
using Boozewasher.Web.Extensions;
...
namespace Boozewasher.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
